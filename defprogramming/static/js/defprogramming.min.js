...
function Sandwich(t,i){"use strict";this.init(t,i)}!function(){"use strict";Sandwich.prototype={init:function(t,i){this.root=t,this.list=i,this.btnUp=this.root.querySelector(".widget-sandwich-up"),this.btnDown=this.root.querySelector(".widget-sandwich-down"),this.setup().bind()},setup:function(){return this},bind:function(){}}}();
